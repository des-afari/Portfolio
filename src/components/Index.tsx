    ...
    <section className='px-4 md:px-6 lg:h-screen lg:sticky lg:top-0 lg:py-16'> 
      ...
      <div className='py-16 hidden lg:block'>
        <ul className='text-sm space-y-3'>
          <li>
            <a href="#about" className={activeSection === 'about' ? 'active': 'inactive'}>
              <div></div>
              <p className='font-bold'>ABOUT</p>
            </a>
          </li>
          <li>
            <a href="#projects" className={activeSection === 'projects' ? 'active': 'inactive'}>
              <div></div>
              <p className='font-bold'>PROJECTS</p>
            </a>
          </li>
          <li>
            <a href="#education" className={activeSection === 'education' ? 'active': 'inactive'}>
              <div></div>
              <p className='font-bold'>EDUCATION</p>
            </a>
          </li>
          <li>
            <a href="#technologies" className={activeSection === 'technologies' ? 'active': 'inactive'}>
              <div></div>
      ...
      <div className='flex items-center gap-x-4 mt-16 lg:mt-0'>
        <span>
