      ...
      <div className='flex items-center gap-x-5 mt-16 lg:mt-0'>
        ...
        <span className='ml-6'>
          <a href="https://desmondafari.com/downloads/Desmond_Afari_Resume.pdf" download rel='noreferrer'>
            <button className='flex items-center gap-x-1 bg-zinc-700 px-3 py-1 rounded-full border-2 border-zinc-500 hover:bg-zinc-700/70 transition-colors'>
              <svg width="16" height="16" className='stroke-zinc-400' viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
